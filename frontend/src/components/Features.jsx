      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.5fr_2fr] gap-6 gap-y-12 rounded-xl">
        ...
        <div className="flexCenter flex-wrap sm:flex-nowrap gap-x-5">
          <div className="p-4 rounded-3xl">
            ...
            <p>
              Exceptional quality. Timeless design. Made to go the distance.
            </p>
          </div>
          ...
          <div className="p-4 rounded-3xl">
            ...
            <p>
              Speed meets reliability. Your order, delivered fast and
              hassle-free.
            </p>
          </div>
          ...
          <div className="p-4 rounded-3xl">
            ...
            <p>Shop with confidence, secure payments every step of the way.</p>
          </div>
        </div>
      </div>
    </section>
