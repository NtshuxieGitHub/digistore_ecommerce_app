        ...
        <div className="flex gap-12 flex-col xl:flex-row bg-primary rounded-2xl p-3 mb-6">
          ...
          <div className="flex-[1.5] rounded-2xl xl:px-7">
            ...
            <div className="flex items-center gap-x-4">
              ...
              <button
                className="btn-light !rounded-lg !py-3"
                onClick={() => setIsfilled(!isFilled)}
              >
                <FaHeart
                  className={`text-2xl transition-all duration-300 ${
                    isFilled ? "text-red-500" : "text-transparent stroke-black"
                  }`}
            ...
            <div className="mt-2 flex flex-col gap-1 text-gray-30 text-[14px]">
              <p className="">Authenticity you Can Trust</p>
              <p className="">Enjoy Cash on Delivery for your Convenience</p>
              <p className="">Enjoy Cash on Delivery for your Convenience</p>
            </div>
          </div>
        </div>
